...
ARG PACKAGE_URL="https://github.com/home-assistant/core/releases/download/2026.4.0/homeassistant-2026.4.0-linux-aarch64.tar.xz"
...
RUN --mount=type=cache,target=/var/cache/apt,sharing=locked \
    ...
    apt-get update && apt-get install -y --no-install-recommends \
      ...
      libxmlsec1 \
      zlib1g \
 && curl -L -f "https://github.com/AlexxIT/go2rtc/releases/download/v${GO2RTC_VERSION}/go2rtc_linux_arm64" -o /usr/bin/go2rtc \
